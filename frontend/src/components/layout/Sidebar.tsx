...
const Sidebar = () => {
  ...
  const navItems: NavItem[] = [
    { 
      to: '/search', 
      label: 'Expert Search', 
      roles: ['user', 'planner', 'admin', 'super_user'],
      icon: (
    ...
    { 
      to: '/engagements', 
      label: 'Engagements', 
      roles: ['planner', 'admin', 'super_user'],
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      ...
      <aside className="bg-secondary w-16 min-h-screen p-4 transition-all duration-300 border-r border-secondary-dark">
        <div className="mb-6 flex flex-col items-center space-y-4">
          <button 
            ...
            className="text-white hover:text-neutral-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 rounded p-1 transition-colors"
