        ...
        try:
            ...
            for expert in experts:
                ...
                if not cursor.fetchone():
                    print(
                        f"  Warning: Expert {expert_id} not found in database, skipping..."
                    )
                    continue
                ...
                for exp_entry in expert["experience_entries"]:
                    try:
                        ...
                        error_msg = (
                            f"Error inserting experience for expert {expert_id}: {e}"
                        )
                ...
                for edu_entry in expert["education_entries"]:
                    try:
                        ...
                        error_msg = (
                            f"Error inserting education for expert {expert_id}: {e}"
                        )
                        errors.append(error_msg)
                        print(f"  {error_msg}")
...
if __name__ == "__main__":
    ...
    BIO_FILES_DIR = "files/bios_formatted"
