...
CREATE INDEX idx_expert_experience_expert_id ON expert_experience_entries(expert_id);
CREATE INDEX idx_expert_education_expert_id ON expert_education_entries(expert_id);
